...
Config.Languages = {
	...
	['hu'] = { -- Hungary đź‡¬đź‡§
        ['emotes'] = 'Hangulatjelek đźŽ¬',
        ['danceemotes'] = "đź•ş Táncos Hangulatjelek",
        ['animalemotes'] = "đź© Állati Hangulatjelek",
        ['propemotes'] = "đź“¦ Prop Hangulatjelek",
        ['favoriteemotes'] = "đźŚź Kedvencek",
        ['favoriteinfo'] = "Válassza ki itt a hangulatjelet, hogy kedvenceként állítsa be.",
        ['rfavorite'] = "Kedvenc visszaállítása",
        ['prop2info'] = "âť“ A Prop Emotes a végén található",
        ['set'] = "Állítsa be (",
        ['setboundemote'] = ") hogy legyél a kötött hangulatod?",
        ['newsetemote'] = "~w~ most a kötött hangulatjel, nyomja meg a ~g~CapsLock~w~ billentyűt a használatához.",
        ['cancelemote'] = "Az Emote visszavonása đźš·",
        ['cancelemoteinfo'] = "~r~X~w~ Törli az éppen lejátszott hangulatjelet",
        ['walkingstyles'] = "Séta stílusok đźš¶đźŹ»â€Ťâ™‚ď¸Ź",
        ['resetdef'] = "Visszaállítás alapértelmezettre",
        ['normalreset'] = "Normál (Reset)",
        ['moods'] = "Hangulatok đź’",
        ['infoupdate'] = "Jóváírások és javaslatok đź™ŹđźŹ»",
        ['infoupdateav'] = "Információ (frissítés elérhető)",
        ['infoupdateavtext'] = "Frissítés elérhető, töltse le a legújabb verziót innen ~y~https://github.com/TayMcKenzieNZ/dpemotes~w~",
        ['suggestions'] = "Javaslatok?",
        ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ a FiveM fórumokon, ha bármilyen funkcióval/hangulattal kapcsolatos javaslatot szeretne kapni! âś‰ď¸Ź",
        ['notvaliddance'] = "nem érvényes tánc.",
        ['notvalidemote'] = "nem érvényes hangulatjel.",
        ['nocancel'] = "Nincs visszavonható hangulatjel.",
        ['maleonly'] = "Ez az emote csak férfi, elnézést!",
        ['emotemenucmd'] = "Az animációk menü megnyitásához használja a /emotemenu parancsot.",
        ['shareemotes'] = "đź‘« Megosztott hangulatjelek",
        ['shareemotesinfo'] = "Egy közeli személy meghívása emote-ra Hívjon meg egy közeli személyt emote-ra",
        ['sharedanceemotes'] = "đź•ş Közös táncok",
        ['notvalidsharedemote'] = "nem érvényes megosztott hangulatjel.",
        ['sentrequestto'] = "Kérés elküldve a következőnek~y~",
        ['nobodyclose'] = "Nics közeledben ~r~senki~w~.",
        ['doyouwanna'] = "~y~Y~w~ elfogadni, ~r~L~w~ elutasítani(~g~",
        ['refuseemote'] = "Hangulatjel visszautasítva!",
        ['makenearby'] = "játékra készteti a közeli játékost",
        ['useleafblower'] = "Nyomja meg ~y~G~w~ a levélfúvó használatához.",
        ['camera'] = "Nyomja meg ~y~G~w~ fényképezőgép vaku használatához.",
        ['makeitrain'] = "Nyomja meg ~y~G~w~ hogy eső legyen.",
        ['pee'] = "Tartsa nyomja ~y~G~w~ ,hogy pisiljen.",
        ['spraychamp'] = "Tartsa nyomja ~y~G~w~ pezsgőt locsolni",
        ['stun'] = "Nyomja meg ~y~G~w~ ,hogy 'használja' kábító fegyvert.",
        ['vape'] = "Nyomja meg ~y~G~w~ ,hogy gőzölni.",
        ['bound'] = "Összekötött ",
        ['to'] = "hoz",
        ['currentlyboundemotes'] = " Jelenleg kötött hangulatjelek:",
        ['notvalidkey'] = "nem érvényes kulcs.",
        ['keybinds'] = "đź”˘ Billentyűzetek",
        ['keybindsinfo'] = "Használni",
        ['searchemotes'] = "đź”Ť Emotes keresése",
        ['searchinputtitle'] = "Keresés:",
        ['searchmenudesc'] = "%s eredmények '~r~%s~w~':",
        ['searchnoresult'] = "Nincs találat a keresésre '~r~%s~w~'.",
        ['searchshifttofav'] = "Tartsa lenyomva az L-Shift billentyűt, és nyomja meg az Enter billentyűt a kedvencként való beállításhoz.",
        ['searchcantsetfav'] = "A megosztott hangulatjelek nem állíthatók be kedvencként.",
        ['invalidvariation'] = "Érvénytelen textúraváltozat. Az érvényes választások a következők: %s"
    },
    ['fi'] = { -- Finnish 🇫🇮
        ['emotes'] = 'Animaatiot 🎬',
